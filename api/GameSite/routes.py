from flask import Flask, send_file, jsonify,render_template, make_response,Blueprint, render_template
from flask import request
import json
import os
from supabase import create_client, Client

GameSite = Blueprint('GameSite', __name__, template_folder='templates')
